...
import { Currency, Percent, TradeType } from '@mageswap/sdk-core';
import { Trade as V2Trade } from '@mageswap/v2-sdk';
import { FeeOptions, MethodParameters, PermitOptions, Position, Trade as V3Trade } from '@mageswap/v3-sdk';
