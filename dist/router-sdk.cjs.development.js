...
var IApproveAndCall_json = require('@mageswap/swap-router-contracts/artifacts/contracts/interfaces/IApproveAndCall.sol/IApproveAndCall.json');
var v3Sdk = require('@mageswap/v3-sdk');
var IMulticallExtended_json = require('@mageswap/swap-router-contracts/artifacts/contracts/interfaces/IMulticallExtended.sol/IMulticallExtended.json');
var sdkCore = require('@mageswap/sdk-core');
var IPeripheryPaymentsWithFeeExtended_json = require('@mageswap/swap-router-contracts/artifacts/contracts/interfaces/IPeripheryPaymentsWithFeeExtended.sol/IPeripheryPaymentsWithFeeExtended.json');
var ISwapRouter02_json = require('@mageswap/swap-router-contracts/artifacts/contracts/interfaces/ISwapRouter02.sol/ISwapRouter02.json');
